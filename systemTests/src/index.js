...
var forceMachinesShutdown = conf.selenium.serverAddress.forceMachinesShutdown || true; // TODO
...
function runTest(done, fill, validationFunctions) {
    ...
    var steps = [
        ...
        function fillForm(callback) {
            ...
            globalSteps.fillData(fill, callback);
        },
...
xdescribe('test', function () {
    ...
    it('test', function (done) {
        ...
        }, 10 * SECOND, 'nana banana').then(function () {
            done();
        });
    });
    ...
    describe('AWS tests', function () {
        ...
        it('Run with valid data', function (done) {
            ...
            runTest(done, fill, [
                ...
                function (callback) {
                    globalSteps.stepValidateAWSOutput(fill, callback);
                },
                function (callback) {
                    globalSteps.stepValidateInstallationButtons(callback);
                },
